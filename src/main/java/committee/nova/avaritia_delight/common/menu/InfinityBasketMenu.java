    ...
    public void clicked(int slotId, int button, ClickType clickType, Player player) {
        ...
        if (clickType == ClickType.QUICK_CRAFT) {
            ...
            if ((i != 1 || this.quickcraftStatus != 2) && i != this.quickcraftStatus) {
                ...
                if (canItemQuickReplace(this.container, slot, itemStack, true, this.getSlotMaxStack(slot))
                ...
                if (!this.quickcraftSlots.isEmpty()) {
                    ...
                    for (Slot slot1 : this.quickcraftSlots) {
                        ...
                        if (slot1 != null
                                && canItemQuickReplace(this.container, slot1, itemStack1, true, this.getSlotMaxStack(slot1))
                            ...
                            int k = Math.min(this.container.getMaxStackSize(), this.getSlotMaxStack(slot1, itemStack3));
            ...
            if (!itemStack4.isEmpty() && (!slot2.hasItem() || !slot2.mayPickup(player))) {
                ...
                for (int l2 = 0; l2 < 2; l2++) {
                    for (int l3 = l1; l3 >= 0 && l3 < this.slots.size() && itemStack4.getCount() < itemStack4.getMaxStackSize(); l3 += i2) {
                        ...
                        if (slot8.hasItem()
                                && canItemQuickReplace(this.container, slot8, itemStack4, true, this.getSlotMaxStack(slot8))
