...
public class ExtremeSkilletRenderer implements BlockEntityRenderer<ExtremeSkilletBlockEntity> {

    private final Random random = new Random();

    public ExtremeSkilletRenderer(BlockEntityRendererProvider.Context context) {
    }

    @Override
    public void render(ExtremeSkilletBlockEntity skillet, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight, int packedOverlay) {
        Direction direction = skillet.getBlockState().getValue(ExtremeStoveBlock.FACING);
